...
'''/ *种子固定，随机数生成器么此随机结果相同，
参数不重要只要每次都是相同的值，每次的随机序列就相同；0，常用，42
作为魔法数 * /'''
...
def split_data(file_path, label_path, new_file_path, train_rate, val_rate, test_rate):
    ...
    #每个元素都是白标签和图片对应的数据集合("001", "001.jpg", "001.txt"),
...
if __name__ == '__main__':
    file_path = r"/autodl-nas/data/data_901/test/images"  # 图片文件夹
    label_path = r'/autodl-nas/data/data_901/test/labels'  # 标签文件夹
    new_file_path = r"./VOCdevkit"  # 新数据存放位置cd
